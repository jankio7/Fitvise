...
export default function UpdateDietplan(){
    ...
    useEffect(()=>{
        const fetchData=()=>{
            onSnapshot(doc(db,"dietplans",id),(DietplanData)=>{
                const FillData=DietplanData.data()
                setGoals(FillData.goals)
                setTitle(FillData.title)
                setCuisine(FillData.cuisine)
                setType(FillData.type)
                setDescription(FillData.description)
                setDuration(FillData.duration)
                setMax(FillData.max)
                setMin(FillData.min)
            })
        }
    ...
    const saveData=async ()=>{
        try{ 
           ...
           // console.log(data);
            await updateDoc(doc(db, "dietplans",id),data)
                                ...
                                <div className="row no-gutters">
                                    <div className="col-lg-8 col-md-7 order-md-last d-flex align-items-stretch">
                                        <div className="contact-wrap w-100 p-md-5 p-4">
                                            <h3 className="mb-4"> Update Diet plan</h3>
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-12">
                                                        <div className="form-group">
                                                            ...
                                                            <select value={cuisine} onChange={(event)=>{
