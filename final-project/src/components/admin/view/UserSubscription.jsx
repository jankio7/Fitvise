...
export default function UserSubscription() {
    ...
    const fetchData = () => {
        let q=query(collection(db, "subscriptions"), where("userId","==", sessionStorage.getItem("userId")))
                                    ...
                                    <div className="block-7">
                                        <div className="text-center">
                                            ...
                                            <ul className="pricing-text mb-5">
                                                ...
                                                <li>
                                                    <span className="fa fa-check mr-2" />
                                                    Calories: {el?.diet?.minCalories}-{el?.diet?.maxCalories}
                                                </li>
                                                <li>
                                                    <span className="fa fa-check mr-2" />
                                                    {el?.diet?.description}
                                            ...
                                            <Link to={`/viewDietDetails/${el?.dietId}`} className="btn btn-primary px-4 py-3">
                                               View Plan
                                            </Link>
                                        </div>
                                    </div>
