...
export default function UpdateDietdetails(){
    ...
    useEffect(()=>{
        const fetchData=()=>{
            onSnapshot(doc(db,"dietdetails",id),(DietdetailData)=>{
                const FillData=DietdetailData.data()
                setDiet(FillData.diet)
                setDay(FillData.day)
                setMeal(FillData.meal)
                setTime(FillData.time)
                setItem(FillData.item)
                setQuantity(FillData.quantity)
                setCalorie(FillData.calorie)
                setRecipe(FillData.recipe)
                setProtein(FillData.protein)
                setCarbohydrates(FillData.carbohydrates)
                setFats(FillData.fats)
                setFibre(FillData.fibre)
                setSugar(FillData.sugar)
            })
        }
        fetchData()
        console.log(id);
